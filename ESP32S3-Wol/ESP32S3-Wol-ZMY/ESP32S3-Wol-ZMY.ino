...
// ====== 网络和MQTT配置 ======
const char* ssid = "HKR208";
const char* password = "HKR12345";
const char* mqtt_server = "192.168.110.221"; // 例如 "192.168.1.100"
const int mqtt_port = 1883; // 默认端口
const char* mqtt_topic_sub = "home/desktop/wol"; // 订阅的主题，用于接收指令
...
void setup() {
    ...
    // 初始化WOL
    WOL.setRepeat(3, 100); // 可选：发送3次，每次间隔100ms，提高唤醒成功率
}
